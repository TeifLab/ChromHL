...
for(i in in.files){
	...
	matplot(x[,1],x[,3:5],xlab="Lattice unit",ylab="Chromatin state",col=c("black","red","blue"),type="l",lty=1)
	
	# Mark centre of region with dotted line
	abline(v=reg_centre, lty=2)
